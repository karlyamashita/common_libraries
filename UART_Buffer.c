 ...
 * Return: 1 if overflow, 0 if added to queue
 *
 */
int UART_TX_AddDataToBuffer(UartBufferStruct *msgOut, uint8_t *msgIN, uint32_t size)
{
    uint8_t i = 0;
    ...
    RingBuff_Ptr_Input(&msgOut->tx.ptr, msgOut->tx.queueSize);
