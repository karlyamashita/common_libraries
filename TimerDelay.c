...
uint32_t genericTimer[MAX_TIMERS] = {0}; // array that holds timer values for each timer instance
uint32_t timerInstance = 0; // timer instance

/*
description: Declare an uint8_t variable in your code and save the pointer value called from this function.
...
/*
description: Call this function from SysTick_Handler() in stm32f1xx_it.c
...
/*
description: Call this function to return the timer value
input: The timer instance
output: none
return: The current timer value of the timer instance
*/
...
/*
description: Set the timer instance to a value, usually you would reset the value to zero.
